...
local Window = OrionLib:MakeWindow({Name = "Fling Things and People", HidePremium = true, SaveConfig = true, ConfigFolder = "FTAPConfig", IntroEnabled = false, KeyToOpenWindow = "M", FreeMouse = true})
